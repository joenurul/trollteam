...
echo 'echo -e "\e[94m    #+#    #+# #+#    #+# #+#    #+#    #+#       "' >> .bashrc
echo 'echo -e "\e[94m    #########  ###    ###  ########     ###       "' >> .bashrc
echo 'echo -e "\e[94m           AutoScriptVPS by  _Joekers_            "' >> .bashrc
echo 'echo -e "\e[0m                                                   "' >> .bashrc
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/joenurul/trollteam/master/Files/Nginx/nginx.conf"
mkdir -p /home/vps/public_html
echo "<h1><center>AutoScriptVPS by _Joekers_</center></h1>" > /home/vps/public_html/index.html
...
echo "<h3><center>You Can Also Contact Me at <a href="https://www.facebook.com/Joekers">Facebook</a> and <a href="https://twitter.com/Joekers">Twitter</a></center></h3>" >> /home/vps/public_html/index.html
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/joenurul/trollteam/master/Files/Nginx/vps.conf"
...
sed -i 's|export KEY_PROVINCE="CA"|export KEY_PROVINCE="Kuala_Lumpur"|' /etc/openvpn/easy-rsa/vars
sed -i 's|export KEY_CITY="SanFrancisco"|export KEY_CITY="Kuala_Lumpur"|' /etc/openvpn/easy-rsa/vars
sed -i 's|export KEY_ORG="Fort-Funston"|export KEY_ORG="trollteam"|' /etc/openvpn/easy-rsa/vars
sed -i 's|export KEY_EMAIL="me@myhost.mydomain"|export KEY_EMAIL="joekers432@gmail.com"|' /etc/openvpn/easy-rsa/vars
sed -i 's|export KEY_OU="MyOrganizationalUnit"|export KEY_OU="trollteam"|' /etc/openvpn/easy-rsa/vars
sed -i 's|export KEY_NAME="EasyRSA"|export KEY_NAME="Joekers"|' /etc/openvpn/easy-rsa/vars
sed -i 's|export KEY_OU=changeme|export KEY_OU=Joekers|' /etc/openvpn/easy-rsa/vars
...
# Setting Server
cd /etc/openvpn/
wget "https://raw.githubusercontent.com/joenurul/trollteam/master/Files/OpenVPN/server.conf"

#Create OpenVPN Config
cd
mkdir -p /home/vps/public_html
cd /home/vps/public_html/
wget "https://raw.githubusercontent.com/joenurul/trollteam/master/Files/OpenVPN/client.ovpn"
...
cd /etc/ufw/
wget "https://raw.githubusercontent.com/joenurul/trollteam/master/Files/OpenVPN/before.rules"
cd
ufw enable
ufw status
ufw disable
...
# Install BadVPN
cd
wget -O /usr/bin/badvpn-udpgw "https://github.com/joenurul/trollteam/raw/master/Files/BadVPN/badvpn-udpgw"
if [ "$OS" == "x86_64" ]; then
  wget -O /usr/bin/badvpn-udpgw "https://github.com/joenurul/trollteam/raw/master/Files/BadVPN/badvpn-udpgw64"
fi
...
wget -O /etc/squid3/squid.conf "https://raw.githubusercontent.com/joenurul/trollteam/master/Files/Squid/squid3.conf"
...
wget -O /etc/stunnel/stunnel.pem "https://raw.githubusercontent.com/joenurul/trollteam/master/Files/Stunnel/stunnel.pem"
wget -O /etc/stunnel/stunnel.conf "https://raw.githubusercontent.com/joenurul/trollteam/master/Files/Stunnel/stunnel.conf"
...
wget "https://github.com/joenurul/trollteam/raw/master/Files/Others/ddos-deflate-master.zip"
...
# Banner
rm /etc/issue.net
wget -O /etc/issue.net "https://raw.githubusercontent.com/joenurul/trollteam/master/Files/Others/issue.net"
...
wget -O screenfetch "https://raw.githubusercontent.com/joenurul/trollteam/master/Files/Others/screenfetch"
chmod +x screenfetch
...
echo -e "\e[94m[][][]======================================[][][]"
echo -e "\e[0m                                                   "
echo -e "\e[94m           AutoScriptVPS by  _Joekers_            "
echo -e "\e[94m                                                  "
